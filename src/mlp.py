...
class Mlp(object):
    ...
    def fit(self, X, Y, learning_rate=0.0001, batch_size=1, epochs=5000, momentum=0):
        i = 0
        epoch = 0
        while epoch < epochs:
            print("************ new epoch **************")
    ...
    def update_weights(self, learning_rate, momentum):
        for n in range(1, self.nb_layers):
            ...
            self.layers[n].biases += (0 if self.layers[n].output_layer else 1) * learning_rate * self.layers[n].local_gradients
